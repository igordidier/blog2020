...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function addArticle(\App\Entity\Article $ye): \App\Entity\Category
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addArticle', [$ye]);

        return parent::addArticle($ye);
    }

    /**
     * {@inheritDoc}
     */
    public function removeArticle(\App\Entity\Article $ye): \App\Entity\Category
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeArticle', [$ye]);

        return parent::removeArticle($ye);
    }
