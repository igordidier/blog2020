...
class __TwigTemplate_03696d6702efda7253557a5bfdde62c3fc09e602b8ae1a13a44c4d8e09f08096 extends Template
{
    private $source;
    private $macros = [];
...
>
    ...
    <input type=\"hidden\" name=\"_token\" value=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 6, $this->source); })()), "id", [], "any", false, false, false, 6))), "html", null, true);
        echo "\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('article_delete', {'id': article.id}) }}\"
      onsubmit=\"return confirm('Voulez vous vraiment supprimer cet article?');\"
      class=\"d-inline\"
>
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
...
", "article/_delete_form.html.twig", "C:\\Users\\33612\\Documents\\cours\\b2\\php-syphony\\codeblog_20-21\\templates\\article\\_delete_form.html.twig");
    }
}
