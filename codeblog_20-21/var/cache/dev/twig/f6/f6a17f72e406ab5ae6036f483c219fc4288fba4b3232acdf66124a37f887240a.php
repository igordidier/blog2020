...
class __TwigTemplate_2620e032e46f50209006ab99f1f035619557fad4dfbedbc5885c7ca3e6181a38 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base_home.html.twig", "article/show.html.twig", 1);
    ...
    <div>
        ...
        // line 6
        ((twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 6, $this->source); })()), "createdAt", [], "any", false, false, false, 6)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 6, $this->source); })()), "createdAt", [], "any", false, false, false, 6), "Y-m-d H:i"), "html", null, true))) : (print ("")));
        echo "</small>

        | Catégorie <strong>";
        // line 8
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 8, $this->source); })()), "category", [], "any", false, false, false, 8), "html", null, true);
        echo "</strong>
    </div>
    <p>
        ";
...
";
    ...
    {
        return array (  96 => 16,  91 => 14,  85 => 11,  79 => 8,  74 => 6,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    <h1>{{ article.title }}</h1>
    <div>
        <small class=\"text-muted\">{{ article.createdAt ? article.createdAt|date('Y-m-d H:i') : '' }}</small>
...
{% endblock %}
", "article/show.html.twig", "C:\\Users\\33612\\Documents\\cours\\b2\\php-syphony\\codeblog_20-21\\templates\\article\\show.html.twig");
    }
}
